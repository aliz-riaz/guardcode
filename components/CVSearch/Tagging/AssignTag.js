...
import { fetchUserSWPProfileAgainstCVSearch } from "../../../redux/actions/cvSearchAction";
...
const AssignTag = (props) => {
  ...
  const maxLength = 50;
  // useEffect(async () => {
  //   await await props.fetchUserSWPProfileAgainstCVSearch(
  //     props.user_token,
  //     props.jobSeekerId
  //   );
  // }, []);
  const reloadProfile = async () => {
    await props.fetchUserSWPProfileAgainstCVSearch(
      props.user_token,
