...
import styles from "./EmptyStateForChat.module.scss";

const EmptyStateForChat = () => {
  return (
    <div className={`${styles.emptyChat}`}>
      <div className={`text-center`}>
        ...
        <div className="mt-4">
          ...
          <Link href="/jobpost">
            <button className="btn btn-sm btn-green btn-left-icon w-100 w-md-auto mx-2">
              <i>
                <svg
...
export default EmptyStateForChat;
