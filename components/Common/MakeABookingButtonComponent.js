    ...
    <>
      <div className="text-right mt-3 mt-md-4 mb-3 mb-md-4 w-md-auto w-100 ml-auto">
        <Link href="/booking/step-1">
          <button
            className="btn btn-md btn-green btn-left-icon w-100 booking-button"
            onClick={() => {
          ...
          >
            ...
            <span className="">Make a Booking</span>
          </button>
        </Link>
      </div>
    </>
...
export default connect(null, mapDispatchToProps)(MakeABookingButtonComponent);
