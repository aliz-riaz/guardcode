  ...
  return (
    <div className={styles.add_new_card}>
      ...
      <div className={styles.card}>
        <img
          src={`${process.env.APP_URL}/images/cards-list.png`}
        ...
        <div className={styles.checkbox_wrap}>
          <input
            ...
            checked={isDefaultChecked && "checked"}
            onChange={(e) => {
      ...
      <div className={`mt-lg-4 mt-3 text-right ${styles.buttons_wrapper}`}>
        <button
          type="button"
        ...
        >
          Add Card {isLoading && <Spinner size="sm" />}
        </button>
      </div>
    </div>
  );
